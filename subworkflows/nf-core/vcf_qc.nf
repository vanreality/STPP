...
include { VCFTOOLS as VCFTOOLS_SUMMARY    } from '../../modules/vcftools/main'
include { VCFTOOLS as VCFTOOLS_TSTV_COUNT } from '../../modules/vcftools/main'
include { VCFTOOLS as VCFTOOLS_TSTV_QUAL  } from '../../modules/vcftools/main'
