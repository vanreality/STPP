...
include { BUILD_INTERVALS                                     } from '../../modules/build_intervals/main'
include { CREATE_INTERVALS_BED                                } from '../../modules/create_intervals_bed/main'
include { GATK4_INTERVALLISTTOBED                             } from '../../modules/gatk4/intervallisttobed/main'
include { TABIX_BGZIPTABIX as TABIX_BGZIPTABIX_INTERVAL_SPLIT } from '../../modules/tabix/bgziptabix/main'
